...
public class CroppingCv extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TestSamplePipeLine stone_pipeline;
        ...
        //phone_camera = new OpenCvWebcam(hardwareMap.get(WebcamName.class,"Webcam"),cameraMonitorViewId);


        phone_camera.openCameraDevice();

        stone_pipeline = new TestSamplePipeLine();
...
//
    public static double right_one=(17f / 32f);
    public static double right_two=(5f / 32f);
    public static double right_three=(23f / 32f);
    public static double right_four=(7f / 32f);

    public static int left_one=50;
    public static int left_two=50;
    public static int left_three=200;
    public static int left_four=200;
