    ...
    public void runOpMode() {
        ...
        if (patternFinal == AutoCVUtil.Pattern.PATTERN_A) {
            ...
            Trajectory moveToSecondStonePatternA = new TrajectoryBuilder(drive.getPoseEstimate(), BASE_CONSTRAINTS)
                    ...
                    .lineTo(new Vector2d(-0, -40), new LinearInterpolator(Math.toRadians(180), Math.toRadians(0)))

                    .lineTo(new Vector2d(-10, -40), new LinearInterpolator(Math.toRadians(180), Math.toRadians(0)))
//
                    //.lineTo(new Vector2d(-15, -30), new LinearInterpolator(Math.toRadians(180), Math.toRadians(-30)))
            ...
            Trajectory moveToFoundationSecondTimePatternA = new TrajectoryBuilder(drive.getPoseEstimate(), BASE_CONSTRAINTS)
                    ...
                    .lineTo(new Vector2d(0.0, -45), new LinearInterpolator(Math.toRadians(160.0), Math.toRadians(20.0)))
